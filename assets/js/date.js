export default function dateGeneral() {
    var canastaBT2 = {
        ...
        2024: [596823.18, 690901.57, 773385.1, 828158.19, 851350.87, 873168.77, 900647.65, 939886.66, 964619.82, 986586.32, '---', '---'],
        2025: ['---', '---', '---', '---', '---', '---', '---', '---', '---', '---', '---', '---']
    },
        canastaBA2 = {
            ...
            2024: [285561.33, 322851.20, 358048.65, 373044.24, 386977.66, 393319.27, 405697.13, 421473.84, 428719.92, 436619.53, '---', '---'],
            2025: ['---', '---', '---', '---', '---', '---', '---', '---', '---', '---', '---', '---']
        },
        canastaBT = {
            ...
            2024: [532520.07, 581933.0, 653898.18, 701288.93, 736205.39, 752534.2, 790910.85, 822234.27, 841358.62, 885407.08, '---', '---'],
            2025: ['---', '---', '---', '---', '---', '---', '---', '---', '---', '---', '---', '---']
        },
        canastaBA = {
            ...
            2024: [252378.18, 275821.33, 305559.9, 324670.8, 331624.04, 342061.0, 356266.15, 370375.8, 375606.53, 393514.26, '---', '---'],
            2025: ['---', '---', '---', '---', '---', '---', '---', '---', '---', '---', '---', '---']
        },
        ...
        dolarBlue = {
            ...
            2024: [1205, 1037.5, 1015, 1042.5, 1227.5, 1385, 1375, 1392.5, 1307.5, 1217.5, 1190, '---',],
            2025: ['---', '---', '---', '---', '---', '---', '---', '---', '---', '---', '---', '---']
        },
        ...
        inflacionNEA = {
            ...
            2024: [19.50, 10.9, 10.3, 6.3, 3.7, 4.4, 4.6, 4.4, 3.3, 2.6, '---', '---'],
            2025: ['---', '---', '---', '---', '---', '---', '---', '---', '---', '---', '---', '---']
        },
        ...
        inflacionNac = {
            ...
            2024: [20.61, 13.24, 11.01, 8.83, 4.20, 4.58, 4.0, 4.2, 3.5, 2.7, '---', '---'],
            2025: ['---', '---', '---', '---', '---', '---', '---', '---', '---', '---', '---', '---']
        },
        ...
        sdmng = {
            ...
            2024: [250000, 250000, 250000, 380000, 400000, 400000, 420000, 420000, 420000, 420000, 420000, '---'],
            2025: ['---', '---', '---', '---', '---', '---', '---', '---', '---', '---', '---', '---']
        };
