export function dateGral() {
    ...
    const canastaBTNac = {
        ...
        2026: [1360298.93, 1397671.83, 1434463.81, 1469767.89, 1498741.40, 1531472.91, '---', '---', '---', '---', '---', '---', '---']
    };
    ...
    const canastaBANac = {
        ...
        2026: [623990.34, 644088.41, 658010.93, 665053.35, 681246.09, 689852.67, '---', '---', '---', '---', '---', '---']
    };
    ...
    const inflacionNac = {
        ...
        2026: [2.90, 2.90, 3.40, 2.6, 2.1, 1.9, '---', '---', '---', '---', '---', '---']
    };
    ...
    const inflacionNea = {
        ...
        2026: [3.80, 3.10, 4.10, 2.7, 2.6, 1.9, '---', '---', '---', '---', '---', '---']
    };
