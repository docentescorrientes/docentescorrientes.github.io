export function dateGral() {
    ...
    const canastaBTNac = {
        ...
        2025: [1033715.62, 1057923.42, 1100266.99, 1110063.43, 1110623.65, 1128398.01, 1149352.91, 1160780.04, 1176852.05, 1213798.81, 1257329.03, 1308713.26],
        2026: [1360298.93, 1397671.83, 1434463.81, 1469767.89, 1498741.40, 1531472.91, 1564715.90, 1605497.35, '---', '---', '---', '---', '---']
    };
    ...
    const canastaBANac = {
        ...
        2025: [453384.05, 468107.72, 495615.76, 502291.15, 500280.92, 506008.08, 515404.89, 520529.16, 527736.34, 544304.4, 566364.43, 589510.48],
        2026: [623990.34, 644088.41, 658010.93, 665053.35, 681246.09, 689852.67, 708016.24, 726469.38, '---', '---', '---', '---']
    };
    ...
    const inflacionNac = {
        ...
        2026: [2.90, 2.90, 3.40, 2.6, 2.1, 1.9, 2.1, 1.7, '---', '---', '---', '---']
    };
    ...
    const canastaBTNea = {
        ...
        2025: [861443.55, 905038.64, 926655.27, 966341.61, 969276.81, 972308.74, 980945.23, 972115.35, 973446.73, 1002184.10, 1007250.21, 1058098.03],
        2026: [1094097.44, 1131293.11, 1158439.03, 1200549.96, 1155822.50, 1274131.71, 1288690.25, '---', '---', '---', '---', '---']
    };
    ...
    const canastaBANea = {
        ...
        2025: [377826.12, 396946.76, 406427.75, 423834.04, 425121.41, 426451.20, 430239.13, 426366.38, 426950.32, 439554.43, 447666.76, 470265.79],
        2026: [486265.53, 502796.94, 514861.79, 533577.76, 513698.89, 566280.76, 572751.22, '---', '---', '---', '---', '---']
    };
    ...
    const inflacionNea = {
        ...
        2026: [3.80, 3.10, 4.10, 2.7, 2.6, 1.9, 2.0, 1.8, '---', '---', '---', '---']
    };
    ...
    const dolarBlue = {
        ...
        2025: [1220, 1225, 1300, 1205, 1170, 1210, 1320, 1350, 1445, 1445, 1440, 1440],
        2026: [1475, 1425, 1410, 1430, 1430, 1515, 1565, 1555, '---', '---', '---', '---']
    };
    ...
    const sdmng = {
        ...
        2025: [420000, 500000, 500000, 500000, 500000, 500000, 500000, 500000, 500000, 500000, 500000, 500000],
        2026: [500000, 500000, 500000, 500000, 500000, 500000, 500000, 500000, '---', '---', '---', '---']
    };
