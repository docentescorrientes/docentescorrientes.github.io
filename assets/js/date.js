export function dateGral() {
    ...
    const canastaBTNea = {
        ...
        2025: [861443.55, 905038.64, 926655.27, 966341.61, 969276.81, 972308.74, 980945.23, 972115.35, 973446.73, 1002184.10, '---', '---'],
        2026: ['---', '---', '---', '---', '---', '---', '---', '---', '---', '---', '---', '---']
    };
    ...
    const canastaBANea = {
        ...
        2025: [377826.12, 396946.76, 406427.75, 423834.04, 425121.41, 426451.20, 430239.13, 426366.38, 426950.32, 439554.43, '---', '---'],
        2026: ['---', '---', '---', '---', '---', '---', '---', '---', '---', '---', '---', '---']
    };
