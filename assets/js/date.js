export function dateGral() {
    ...
    // El valor del dólar blue https://www.dolarito.ar/cotizaciones-historicas/dolar/informal/2025/cotizacion-historica-del-dolar-informal-a%C3%B1o-2025 (dolar blue cotización fin del mes)*/
    const dolarBlue = {
        ...
        2025: [1220, 1225, 1300, 1205, 1170, 1210, 1320, 1350, 1445, '---', '---', '---'],
        2026: ['---', '---', '---', '---', '---', '---', '---', '---', '---', '---', '---', '---']
    };
    ...
    const sdmng = {
        ...
        2025: [420000, 500000, 500000, 500000, 500000, 500000, 500000, 500000, 500000, '---', '---', '---'],
        2026: ['---', '---', '---', '---', '---', '---', '---', '---', '---', '---', '---', '---']
    };
