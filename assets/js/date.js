export function dateGral() {
    ...
    const canastaBTNac = {
        ...
        2025: [1033715.62, 1057923.42, 1100266.99, 1110063.43, 1110623.65, 1128398.01, 1149352.91, 1160780.04, 1176852.05, 1213798.81 , '---', '---'],
        2026: ['---', '---', '---', '---', '---', '---', '---', '---', '---', '---', '---', '---']
    };
    ...
    const canastaBANac = {
        ...
        2025: [453384.05, 468107.72, 495615.76, 502291.15, 500280.92, 506008.08, 515404.89, 520529.16, , 527736.34, 544304.4, '---', '---'],
        2026: ['---', '---', '---', '---', '---', '---', '---', '---', '---', '---', '---', '---']
    };
    ...
    const inflacionNac = {
        ...
        2025: [2.20, 2.4, 3.7, 2.8, 1.5, 1.6, 1.9, 1.9, 2.1, 2.3, '---', '---'],
        2026: ['---', '---', '---', '---', '---', '---', '---', '---', '---', '---', '---', '---']
    };
    ...
    const inflacionNea = {
        ...
        2025: [2.50, 1.9, 3.1, 2.7, 1.3, 1.1, 1.7, 1.7, 1.8, 2.2, '---', '---'],
        2026: ['---', '---', '---', '---', '---', '---', '---', '---', '---', '---', '---', '---']
    };
    ...
    const sdmng = {
        ...
        2025: [420000, 500000, 500000, 500000, 500000, 500000, 500000, 500000, 500000, 500000, '---', '---'],
        2026: ['---', '---', '---', '---', '---', '---', '---', '---', '---', '---', '---', '---']
    };
