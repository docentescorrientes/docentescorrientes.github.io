export default function dateGeneral() {
    var canastaBT2 = {
        ...
        canastaBT = {
            ...
            2024: [532520.07, 581933.0, 653898.18, 701288.93, 736205.39, 752534.2, 790910.85, 822234.27, '---', '---', '---', '---'],
            2025: ['---', '---', '---', '---', '---', '---', '---', '---', '---', '---', '---', '---']
        },
        canastaBA = {
            ...
            2024: [252378.18, 275821.33, 305559.9, 324670.8, 331624.04, 342061.0, 356266.15, 370375.8, '---', '---', '---', '---'],
            2025: ['---', '---', '---', '---', '---', '---', '---', '---', '---', '---', '---', '---']
        },
