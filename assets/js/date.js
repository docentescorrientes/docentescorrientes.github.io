export function dateGral() {
    ...
    const canastaBTNac = {
        ...
        2025: [1033715.62, 1057923.42, 1100266.99, 1110063.43, 1110623.65, 1128398.01, 1149352.91, 1160780.04, 1176852.05, 1213798.81, 1257329.03, '---'],
        2026: ['---', '---', '---', '---', '---', '---', '---', '---', '---', '---', '---', '---']
    };
    ...
    const canastaBANac = {
        ...
        2025: [453384.05, 468107.72, 495615.76, 502291.15, 500280.92, 506008.08, 515404.89, 520529.16, , 527736.34, 544304.4, 566364.43, '---'],
        2026: ['---', '---', '---', '---', '---', '---', '---', '---', '---', '---', '---', '---']
    };
    ...
    const inflacionNac = {
        ...
        2025: [2.20, 2.4, 3.7, 2.8, 1.5, 1.6, 1.9, 1.9, 2.1, 2.3, 2.5, '---'],
        2026: ['---', '---', '---', '---', '---', '---', '---', '---', '---', '---', '---', '---']
    };
    ...
    const canastaBTNea = {
        ...
        2025: [861443.55, 905038.64, 926655.27, 966341.61, 969276.81, 972308.74, 980945.23, 972115.35, 973446.73, 1002184.10, 1007250.21, '---'],
        2026: ['---', '---', '---', '---', '---', '---', '---', '---', '---', '---', '---', '---']
    };
    ...
    const canastaBANea = {
        ...
        2025: [377826.12, 396946.76, 406427.75, 423834.04, 425121.41, 426451.20, 430239.13, 426366.38, 426950.32, 439554.43, 447666.76, '---'],
        2026: ['---', '---', '---', '---', '---', '---', '---', '---', '---', '---', '---', '---']
    };
    ...
    const inflacionNea = {
        ...
        2025: [2.50, 1.9, 3.1, 2.7, 1.3, 1.1, 1.7, 1.7, 1.8, 2.2, 2.4, '---'],
        2026: ['---', '---', '---', '---', '---', '---', '---', '---', '---', '---', '---', '---']
    };
    // El valor del dólar blue (dolar blue cotización fin del mes) https://www.dolarito.ar/cotizaciones-historicas/dolar/informal/2025/cotizacion-historica-del-dolar-informal-a%C3%B1o-2025 */
    const dolarBlue = {
