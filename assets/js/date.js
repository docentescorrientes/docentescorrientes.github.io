export default function dateGeneral() {
    var canastaBT2 = {
        ...
        2024: [596823.18, 690901.57, 773385.1, 828158.19, 851350.87, 873168.77, 900647.65, '---', '---', '---', '---', '---'],
        2025: ['---', '---', '---', '---', '---', '---', '---', '---', '---', '---', '---', '---']
    },
        canastaBA2 = {
            ...
            2024: [285561.33, 322851.20, 358048.65, 373044.24, 386977.66, 393319.27, 405697.13, '---', '---', '---', '---', '---'],
            2025: ['---', '---', '---', '---', '---', '---', '---', '---', '---', '---', '---', '---']
        },
        canastaBT = {
        ...
        inflacionNac = {
            ...
            2024: [20.61, 13.24, 11.01, 8.83, 4.20, 4.58, 4.0, '---', '---', '---', '---', '---'],
            2025: ['---', '---', '---', '---', '---', '---', '---', '---', '---', '---', '---', '---']
        },
