export function dateGral() {
    ...
    const canastaBTNac = {
        ...
        2025: [1033715.62, 1057923.42, 1100266.99, 1110063.43, 1110623.65, 1128398.01, 1149352.91, '---', '---', '---', '---', '---'],
        2026: ['---', '---', '---', '---', '---', '---', '---', '---', '---', '---', '---', '---']
    };
    ...
    const canastaBANac = {
        ...
        2025: [453384.05, 468107.72, 495615.76, 502291.15, 500280.92, 506008.08,  515404.89, '---', '---', '---', '---', '---'],
        2026: ['---', '---', '---', '---', '---', '---', '---', '---', '---', '---', '---', '---']
    };
    ...
    const inflacionNac = {
        ...
        2025: [2.20, 2.4, 3.7, 2.8, 1.5, 1.6, 1.9, '---', '---', '---', '---', '---'],
        2026: ['---', '---', '---', '---', '---', '---', '---', '---', '---', '---', '---', '---']
    };
    ...
    const inflacionNea = {
        ...
        2025: [2.50, 1.9, 3.1, 2.7, 1.3, 1.1, 1.7, '---', '---', '---', '---', '---'],
        2026: ['---', '---', '---', '---', '---', '---', '---', '---', '---', '---', '---', '---']
    };
