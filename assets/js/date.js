export function dateGral() {
    ...
    const canastaBTNea = {
        ...
        2026: [1094097.44, 1131293.11, 1158439.03, 1200549.96, 1155822.50, 1274131.71, '---', '---', '---', '---', '---', '---']
    };
    ...
    const canastaBANea = {
        ...
        2026: [486265.53, 502796.94, 514861.79, 533577.76, 513698.89, 566280.76, '---', '---', '---', '---', '---', '---']
    };
    ...
    const dolarBlue = {
        ...
        2026: [1475, 1425, 1410, 1430, 1430, 1515, 1565, '---', '---', '---', '---', '---']
    };
    ...
    const sdmng = {
        ...
        2026: [500000, 500000, 500000, 500000, 500000, 500000, 500000, '---', '---', '---', '---', '---']
    };
