export function dateGral() {
    ...
    const canastaBTNac = {
        ...
        2026: [1360298.93, 1397671.83, 1434463.81, 1469767.89, 1498741.40, '---', '---', '---', '---', '---', '---', '---', '---']
    };
    ...
    const canastaBANac = {
        ...
        2026: [623990.34, 644088.41, 658010.93, 665053.35, 681246.09, '---', '---', '---', '---', '---', '---', '---']
    };
