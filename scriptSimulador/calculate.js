...
function generarTextoCompacto(contrato) {
    ...
    return `Clase ${contrato.claseInfo.clase}: Cargo: ${contrato.claseInfo.cargo}, Categoría: ${contrato.claseInfo.categoria}, de Ubicación geográfica: ${ubicacionPorcentaje} ${horasCatedraTexto}`;
}
