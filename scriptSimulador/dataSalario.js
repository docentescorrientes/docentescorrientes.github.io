...
aumentos.agregarAumento("1 Básico", 2026, 6, 22000, "b");
...
aumentos.agregarAumento("632 Complemento Docente Provincial (en 2 cargos)", 2026, 6, 75000 * 4 / 3, "g"); // ### Tope: hasta dos cargos.
...
aumentos.agregarAumento("171 Compensador Docente Provincial (en 2 cargos)", 2025, 8, -79125, "n"); // ### Tope: hasta dos cargos
aumentos.agregarAumento("171 Compensador Docente Provincial (en 2 cargos)", 2026, 3, -59343.75, "n"); // ### Tope: hasta dos cargos (ESTE)
...
aumentos.agregarAumento("210 Seguro de Vida (Life)", 2025, 10, -231.80, "d");
aumentos.agregarAumento("210 Seguro de Vida (Life)", 2026, 5, -130.00, "d");
aumentos.agregarAumento("210 Seguro de Vida (Life)", 2026, 7, -230.00, "d"); 
